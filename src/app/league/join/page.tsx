      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="backdrop-blur-xl bg-white/10 p-8 rounded-3xl border border-white/20 shadow-2xl">
          <div className="text-center">
            <UserPlusIcon className="mx-auto h-16 w-16 text-red-400 mb-4" />
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-4 py-3 bg-white/5 border border-white/10 placeholder-gray-400 text-white text-center text-2xl tracking-widest rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent backdrop-blur-sm transition-all"
                placeholder="ABCD12"
                maxLength={6}
              />
              <p className="mt-1 text-xs text-gray-400 text-center">Enter the 6-character league code</p>
            </div>
